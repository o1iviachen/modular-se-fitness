        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="divide-y divide-gray-100">
              <div className="px-5 py-4 flex items-center justify-between">
                <div>
                  <div className="font-medium">New Athlete Joins</div>
                  <div className="text-sm text-gray-600">Get notified when athletes join using your code</div>
                </div>
                <ToggleSwitch enabled={settings.newAthleteJoins} onChange={() => handleToggle('newAthleteJoins')} />
              </div>
              <div className="px-5 py-4 flex items-center justify-between">
                <div>
                  <div className="font-medium">Workout Completed</div>
                  <div className="text-sm text-gray-600">Notify when athletes complete workouts</div>
                </div>
                <ToggleSwitch enabled={settings.workoutCompleted} onChange={() => handleToggle('workoutCompleted')} />
              </div>
              <div className="px-5 py-4 flex items-center justify-between">
                <div>
                  <div className="font-medium">New Message</div>
                  <div className="text-sm text-gray-600">When an athlete sends you a message</div>
                </div>
